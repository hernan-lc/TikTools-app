...
export function AppIcon({ size = 28, className }: AppIconProps): JSX.Element {
  return (
    <svg
      className={className}
      width={size}
    ...
    >
      ...
      <path d="M25 30.5h15M25 37.5h11" fill="none" stroke="#141824" strokeWidth="3" strokeLinecap="round" />
    </svg>
  );
}
